...
<header class="l-header  js-header">
    <div class="l-header-top u-clear">
            ...
            <div class="logo ">
                <a href="{!! url('/home') !!}"><img src="assets/images/logo.png" width="253" height="28" alt="BLOG"/></a>
            </div>
...
<!--end header-->
    ...
    <ul class="nav-list">
      <li class="nav-item">
          <a href="{!! url('/content_archive') !!}" class="nav-link">CONTENT ARCHIVE</a>
      </li>
      <li class="nav-item">
          <a href="{!! url('/admin_list') !!}" class="nav-link">CONTENT LIST</a>
      </li>
        <li class="nav-item">
